...
import static Components.Shadow.ShadowType.BOT;
import static Components.Shadow.ShadowType.BOT_LEFT;
import static Components.Shadow.ShadowType.BOT_RIGHT;
import static Components.Shadow.ShadowType.TOP;
import static Components.Shadow.ShadowType.TOP_LEFT;
import static Components.Shadow.ShadowType.TOP_RIGHT;
...
public class UtilShadow {
     ...
     public static void createShadowSearch30(Graphics grphcs, int getWidth, int getHeight, Color getBackground) {
          int SHADOW_SIZE = 3;
          float SHADOW_OPACITY = 0.8f;
          Color SHADOW_COLOR = Color.GRAY;
