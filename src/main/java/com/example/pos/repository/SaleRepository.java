...
public interface SaleRepository extends JpaRepository<Sale, Integer> {
        ...
        @Query(nativeQuery = true, value = "  select sum(psd.qty) from pos_sale ps \r\n" + //
                        ...
                        "        and pp.payment_type = 'cash' and  pos.pos_id = ? and pos.open_date = ?")
        String sumQtySaledByUsd(int empId, String date,String posId,String openDate);
        ...
        @Query(nativeQuery = true, value = " select sum( psd.qty ) from pos_sale ps \r\n" + //
                        ...
                        "    and  pos.pos_id = ? and pos.open_date = ?")
        String sumQtySaledByKhr(int empId, String date,String posId,String openDate);
        ...
        @Query(nativeQuery = true, value = "select sum( psd.qty ) from pos_sale ps \r\n" + //
                        ...
                        "and  pos.pos_id = ? and pos.open_date = ?")
        String totalCountQtyABA(int userId, String date,String posId,String openDate);
        ...
        @Query(nativeQuery = true, value = "select sum(psd.qty)  from pos_sale ps  \r\n" + //
                        ...
                        "and  pos.pos_id = ? and pos.open_date = ?")
        String totalCountQtyMNK(int userId, String date,String posId,String openDate);
        ...
        @Query(nativeQuery = true, value = "select sum( psd.qty ) from pos_sale ps  \r\n" + //
                        ...
                        "and  pos.pos_id = ? and pos.open_date = ?")
        String totalCountQtyExpress(int userId, String date,String posId,String openDate);
        ...
        @Query(nativeQuery = true, value = "select sum(psd.qty)  from pos_sale ps\r\n" + //
                        ...
                        "and  pos.pos_id = ? and pos.open_date = ?")
        String totalCountQtyCredit(int userId, String date,String posId,String openDate);
