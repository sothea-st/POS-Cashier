package com.example.pos.system.layer.repository.paymentRepository;
...
public interface PaymentRepository extends JpaRepository<Payment, Integer> {
        ...
        @Query(nativeQuery =  true , value = "select count(*) from pos_sale where sale_date = ? and sale_is_return = 'returned'")
        int countSaledReturn(String saleDate );
