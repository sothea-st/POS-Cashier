                    ...
                    for (int j = 0; j < dataList.get(i).length; j++) {
                         ...
                         if (dataList.get(i)[j] instanceof String) {
                              ...
                              if (String.valueOf(dataList.get(i)[j]).equals("#")
                                   ...
                                   || String.valueOf(dataList.get(i)[j]).equals("Beginning Qty")
                                   || String.valueOf(dataList.get(i)[j]).equals("Stock In Qty")
                                   || String.valueOf(dataList.get(i)[j]).equals("Available Qty")
                                   || String.valueOf(dataList.get(i)[j]).equals("Stock Out Qty")
                                   || String.valueOf(dataList.get(i)[j]).equals("Return In Qty")
                                   || String.valueOf(dataList.get(i)[j]).equals("Return Out Qty")
                                   || String.valueOf(dataList.get(i)[j]).equals("Ending Qty")) {
