...
public class OpenShiftJdailog extends javax.swing.JDialog {
     ...
     public OpenShiftJdailog(java.awt.Frame parent, boolean modal, Button btnOpenShift) {
          ...
          txtTotalKhr.setValidateAmount("រ");
     ...
     private void buttonSaveMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_buttonSaveMouseClicked
          ...
          try {
               ...
               if (isCheck) {
                    reserveUsd = reserveUsd.replace(",", "").replace("$", "");
                    reserveKhr = reserveKhr.replaceAll(",", "").replace("រ", "");

                    System.err.println("reserveUsd : " + reserveUsd);
                    System.err.println("reserveKhr : " + reserveKhr);
