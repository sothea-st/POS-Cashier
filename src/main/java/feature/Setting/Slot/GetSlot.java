...
public class GetSlot extends javax.swing.JPanel {
     ...
     public GetSlot() {
          ...
          btnEdit.setVisible(JavaPermission.getPermissionDetail(28).getIsUpdate());
          btnDelete.setVisible(JavaPermission.getPermissionDetail(28).getIsUpdate());
     }
    ...
    private void initComponents() {
        ...
        panelLayout.setHorizontalGroup(
            ...
            .addGroup(panelLayout.createSequentialGroup()
                ...
                .addGap(8, 8, 8)
                .addComponent(lbRange, javax.swing.GroupLayout.DEFAULT_SIZE, 167, Short.MAX_VALUE)
                .addContainerGap())
        );
