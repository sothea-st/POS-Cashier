package feature.Setting.Department;
         ...
         try {
              ...
              if (isCheck) {
                   ...
                   fields.add(JavaConflicValidation.builder()
                        ...
                        .msg("This department name kh is already existed!") // message to show 
                        .field(departmentNameKh) // obj of JavaTextField
                        .build());
                   
                     fields.add(JavaConflicValidation.builder()
                        .key("catNameEn") // specific word that exist in key "reason"
                        .msg("This department name is already existed!") // message to show 
                        .field(departmentName) // obj of JavaTextField
                        .build());
