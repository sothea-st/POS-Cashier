...
//               logo.setIcon(new ImageIcon(images));
               ...
               String[] arrStr = data.getPaymentNo().split("=");
               String orgPayment = arrStr[0];
               String returnPayment = arrStr[1];

               invoiceNo.setText(returnPayment);
          ...
          jPanel1Layout.setHorizontalGroup(
               ...
               .addGroup(jPanel1Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                         ...
                         .addGroup(jPanel1Layout.createSequentialGroup()
                              .addComponent(totalKhr, javax.swing.GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE)
                              .addGap(3, 3, 3)
