...
public class ExportReportReturnToEXCEL {

     public static String reportSale = "Reporting Sale Return";

     public static void toExcel(ReportSaleReturnResponse.ReportSaleReturnDetailResponse[] list) {
                    ...
                    for (int j = 0; j < dataList.get(i).length; j++) {
                         ...
                         if (dataList.get(i)[j] instanceof String) {
                              if (String.valueOf(dataList.get(i)[j]).equals("#")
                                   ...
                                   || String.valueOf(dataList.get(i)[j]).equals("Reason")
