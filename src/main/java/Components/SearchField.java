...
public class SearchField extends javax.swing.JPanel {
    ...
    protected void paintComponent(Graphics grphcs) {
        setOpaque(false);
        UtilShadow.createShadowSearch30(grphcs, getWidth(), getHeight(), getBackground());
     ...
     private void initComponents() {
          ...
          layout.setHorizontalGroup(
               ...
               .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                    ...
                    .addComponent(textSearch, javax.swing.GroupLayout.DEFAULT_SIZE, 175, Short.MAX_VALUE)
                    .addGap(15, 15, 15))
          );
