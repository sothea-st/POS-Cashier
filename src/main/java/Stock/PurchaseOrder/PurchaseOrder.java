...
public class PurchaseOrder extends javax.swing.JDialog {
     ...
     private void eventPagination() {
          ...
          paginationPanel1.initEvent(event);
     }
     ...
     public void getListPurchase(JPanel jpanelData, boolean isCheck) {
          try {
               ...
               if (response.isSuccessful()) {
                    ...
                    if (isCheck) {
                         paginationPanel1.setTotalPage(data.getCount(), pageSize);
                    } else {
                         paginationPanel1.resetPage();
                    }
     ...
     private void initComponents() {
          ...
          paginationPanel1 = new pagination.PaginationPanel();
...
//                    }
     ...
     private pagination.PaginationPanel paginationPanel1;
