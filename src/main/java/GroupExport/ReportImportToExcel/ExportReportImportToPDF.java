...
public class ExportReportImportToPDF {
     ...
     public static void printListPdf(ReportImportDetail[] list) throws IOException {
          try {
...
//                    }
               ...
               Object[] columnHead = {"#","Prduct Name", "Prduct Barcode", "Cost", "Quantity", "Amount", "Total","Discount","Import Date"};
